...
const orderApi = "https://marketresearch.onrender.com/ViewCustmization";
// setTimeout(function(){
    ...
    return (
      <>
        ...
        <div className="container convieworder">
          ...
          <br />
          <br />
          Your Request For Custmization Of Report {" "}
          ...
          Has Been Successfully Placed. You Will Receive, The Customized Sample Pages As
          Soon As Possible
          <hr />
