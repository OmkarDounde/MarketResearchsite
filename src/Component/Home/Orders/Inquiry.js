...
const placeOrder = "https://marketresearch.onrender.com/Inquiryrequest";
class SampleForm extends Component {
  ...
  checkout = () => {
    ...
    fetch(placeOrder, {
      ...
      .then(this.props.history.push("/ViewInquiry"));
  };
        ...
        <div id="mainformbody">
          <div id="formbody">
            <div className="formtitle">
              To Inquire About {details.Keyword} Market Report Plz Fill The Form
            </div>
