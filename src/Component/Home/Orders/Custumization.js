...
// const placeOrder = "http://localhost:1226/CustmizationRequest";
const placeOrder = "https://marketresearch.onrender.com/CustmizationRequest";
class SampleForm extends Component {
  ...
  checkout = () => {
    ...
    fetch(placeOrder, {
      ...
      .then(this.props.history.push("/ViewCustmization"));
  };
        ...
        <div id="mainformbody">
          <div id="formbody">
            <div className="formtitle">
              To Get Sample Pages Of {details.Keyword} Market Report Plz Fill The Form
            </div>
