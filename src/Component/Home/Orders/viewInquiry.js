...
const orderApi = "https://marketresearch.onrender.com/ViewInquiry";
// setTimeout(function(){
    ...
    return (
      <>
        ...
        <div className="container convieworder">
          ...
          <br />
          <br />
          Your Request For Inquiry Of Report {" "}
          ...
          Has Been Successfully Placed. You Will Receive, The Meeting timing to Discuss About Your Query.. 
          <hr />
